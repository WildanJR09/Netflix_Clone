...
const Modal = () => {
  ...
  return (
    <MuiModal
      className='fixed left-0 right-0 !top-7 z-50 mx-auto 
      w-full max-w-5xl overflow-hidden overflow-y-scroll 
      ...
      <>
        ...
        <div className='relative pt-[56.25%]'>
          ...
          />
          <div
            className='absolute bottom-10 flex w-full 
              items-center justify-between px-10
              '>
            <div className='flex space-x-2'>
              <button
                className='flex items-center gap-x-2 rounded
              bg-white px-8 font-bold text-xl text-black py-1.5
        ...
        '>
          <div className='space-y-6 text-lg'>
            ...
            <div
              className='flex flex-col gap-x-10 gap-y-4 font-light
            md:flex-row
            '>
